-- =====================================================================
-- AMORÇAGE DU SCHÉMA config — l'oubli du premier amorçage
--
-- Le 28/08 j'ai écrit « les référentiels sont amorcés ». C'était vrai de
-- ref, et de ref seulement : les huit tables de config sont restées
-- vides, alors que sept d'entre elles ont une source au miroir. Constaté
-- le 08/09 en vérifiant que le job board public pouvait lire le logo.
--
-- config.integration reste vide, et c'est correct : elle est A_CREER,
-- sans aucune source.
--
-- CE QUI N'EST DÉLIBÉRÉMENT PAS REPRIS : les 4 webhooks de
-- public.ref_slack_channel. Ce ne sont pas des données mais des
-- identifiants d'authentification, et aucune colonne du modèle ne peut
-- les accueillir.
--
-- Généré par backend/database/amorcage/generer_config.py — régénérer
-- plutôt qu'éditer.
-- =====================================================================
