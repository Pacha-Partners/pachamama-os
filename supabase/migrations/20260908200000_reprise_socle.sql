-- =====================================================================
-- REPRISE DES DONNÉES — SOCLE
-- Généré depuis backend/database/reprise/00_socle.sql, mis au point sur
-- une réplique locale du miroir anonymisé. Rejouable : les identifiants
-- sont déterministes et toutes les insertions sont ON CONFLICT.
-- =====================================================================
